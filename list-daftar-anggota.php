...
<head>
    ...
    <title>Pendaftaran Anggota Perpus Baru | SMK Gamelab Indoenesia</title>
    <style>
        .anggota {
        ...
        .aggota tr:hover {background-color: #ddd;}
    ...
    <table border="1" class="anggota">
        ...
        <tbody>
            ...
            while($anggota = mysqli_fetch_array($query)){
	            ...
	            echo "<td>";
                    // tambahkan kode pada baris <a class='fcc-btn1' >Edit</a>
